...
# Don't use SST5 because I don't have the data lying around
'''
...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder_path", help="path to model folder",
                        default=PATH_GENSEN + 'data/models')
    parser.add_argument("--prefix_1", help="prefix to model 1",
    ...
    parser.add_argument("--strategy", help="Approach to create sentence embedding last/max/best",
                        default="best",  )
    parser.add_argument( "--cuda", help="Use GPU to compute sentence representations",
    ...
    gensen_1 = GenSenSingle(model_folder=args.folder_path, filename_prefix=args.prefix_1,
                            pretrained_emb=args.pretrain, cuda=args.cuda)
