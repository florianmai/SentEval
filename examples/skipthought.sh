...
THEANO_FLAGS='device=cuda3' python skipthought.py --log_file skipthought_all_lower_wiki_all.log --model_file $MODEL_FILE --dict_file $DICTIONARY_FILE --small 0 --lower 1
